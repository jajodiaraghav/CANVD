	...
	<div class="container">
      ...
      <div class="jumbotron">
        <div class="container">
          ...
          This page lists all the datasets that are currently available in <?php include('../logo.php') ?>
          with short description of each dataset, the description of the processing and formatting steps, the compliance with <?php include('../logo.php') ?> standard data model and the publish article corresponds to the dataset.</p>
		      <br>
          ...
          <p class="text-justify">- Brief description of the data processing steps: The published data in the supplementary martials and the website associated with the study contains most of the data items required by <?php include('../logo.php') ?> standard data model. We used these data directly or after few processing to deposite the data into <?php include('../logo.php') ?>. However, we requested the full sequences of the proteins used in the analysis from the authors as they used one protein per gene. Furthermore, some information such as the protein names and Ensembl IDs were obtained from online resources.</p>

          <p>- Compliance of published data with <?php include('../logo.php') ?> standard data model:
          ...
          <p>- Compliance of processed data with <?php include('../logo.php') ?> standard data model:
          <span style="color:#ea2f10"><i class="fa fa-star"></i></span>
          <span style="color:#ea2f10"><i class="fa fa-star"></i></span>
          <span style="color:#ea2f10"><i class="fa fa-star"></i></span>
          <span style="color:#ea2f10"><i class="fa fa-star"></i></span>
          ...
          <p>
          - Compliance of processed data with <?php include('../logo.php') ?> standard data model:
          <span style="color:#ea2f10"><i class="fa fa-star"></i></span>
          <span style="color:#ea2f10"><i class="fa fa-star"></i></span>
          <span style="color:#ea2f10"><i class="fa fa-star"></i></span>
          <span style="color:#ea2f10"><i class="fa fa-star"></i></span>
